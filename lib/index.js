  ...
  StorageService.prototype.getGallery = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        return [2, this.loadData(id).then(function (user) {
          if (user) {
  ...
  StorageService.prototype.uploadCoverImage = function (id, data, sizes) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0: return [4, this.loadData(id)];
          case 1:
            user = _e.sent();
            if (!user) {
              return [2, ''];
            ...
            return [4, this.deleteFileUpload(oldUrl, galary, sizes !== null && sizes !== void 0 ? sizes : this.sizesCover)];
          case 2:
            _e.sent();
            _e.label = 3;
          case 3:
          ...
          case 4:
            ...
            return [4, this.storage.upload(file.data, file.name, this.config.cover)];
          case 5:
            urlOrigin = _e.sent();
            obj = {};
            if (!(index === 0)) return [3, 7];
            obj[this.model.id] = id;
            obj[this.model.cover] = urlOrigin;
            urlUploaded = urlOrigin;
            return [4, this.patchData(obj)];
          case 6:
            res = _e.sent();
            if (res < 1) {
              return [2, ''];
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            galary = user[this.model.gallery];
            return [4, this.deleteFileUpload(oldUrl, galary, sizes !== null && sizes !== void 0 ? sizes : this.sizesImage)];
          case 2:
            _e.sent();
            _e.label = 3;
          case 3:
          ...
          case 4:
            if (!!_b.done) return [3, 8];
            _c = __read(_b.value, 2), index = _c[0], file = _c[1];
            return [4, this.storage.upload(file.data, file.name, this.config.image)];
          case 5:
            urlOrigin = _e.sent();
            obj = {};
            if (!(index === 0)) return [3, 7];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!shouldDelete(oldUrl, galary)) return [3, 2];
            return [4, this.deleteFile(this.storage.delete, oldUrl).catch(function (err) { })];
          case 1:
            _b.sent();
            _b.label = 2;
          case 2:
          ...
          case 3:
            ...
            _b.label = 4;
          case 4:
            if (!!sizes_1_1.done) return [3, 7];
            size = sizes_1_1.value;
            oldSizeURL = removeFileExtension(oldUrl) + '_' + size + '.' + getFileExtension(oldUrl);
            if (!(oldSizeURL && oldSizeURL.length > 0)) return [3, 6];
            if (!shouldDelete(oldSizeURL, galary)) return [3, 6];
            return [4, this.deleteFile(this.storage.delete, oldSizeURL).catch(function (err) { })];
          case 5:
            _b.sent();
            _b.label = 6;
          case 6:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [4, this.storage.upload(data, fileName, this.config.gallery)];
          case 2:
            url = _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            oldGalary = user[this.model.gallery];
            if (!(url !== oldUrl && url !== oldCoverUrl)) return [3, 3];
            return [4, this.deleteFile(this.storage.delete, url)];
          case 2:
            _a.sent();
            _a.label = 3;
          case 3:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4, this.patchData(user)];
          case 2:
            rs = _a.sent();
            return [2, rs >= 1 ? true : false];
        }
      });
    });
  };
...
var GenericStorageService = (function (_super) {
...
var GenericSearchStorageService = (function (_super) {
